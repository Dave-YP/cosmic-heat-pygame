...
def check_events() -> bool: # continue the main loop if true
    global score,bg_y_shift,new_background_activated
    global current_image,background_top,hi_score
    global boss1_spawned,boss2_spawned,boss3_spawned
    global boss1_img,boss2_img,boss3_img
    global bullet_counter,player_life,boss1_health,boss2_health,boss3_health
    ...
    if random.randint(0, 40) == 0 :
        ...
        enemy_object = Enemy1(random.randint(100, WIDTH - 50), random.randint(-HEIGHT, -50),
            enemy_img, )
    ...
    if score >= 3000 and random.randint(0, 40) == 0 and len(enemy2_group) < 2 :
        ...
        enemy2_object = Enemy2(random.randint(200, WIDTH - 100), random.randint(-HEIGHT, -100),
            enemy_img, )
    ...
    if score >= 5000 and not boss1_spawned :
        ...
        boss1_img = boss1_img
        boss1_object = Boss1(random.randint(200, WIDTH - 100), random.randint(-HEIGHT, -100),
            boss1_img, )
    ...
    if score >= 10000 and not boss2_spawned :
        pygame.mixer.Sound('game_sounds/warning.mp3').play()
        boss2_img = boss2_img
        boss2_object = Boss2(random.randint(200, WIDTH - 100), random.randint(-HEIGHT, -100),
            boss2_img, )
    ...
    if score >= 15000 and not boss3_spawned :
        pygame.mixer.Sound('game_sounds/warning.mp3').play()
        boss3_img = boss3_img
        boss3_object = Boss3(random.randint(200, WIDTH - 100), random.randint(-HEIGHT, -100),
            boss3_img, )
        boss3_group.add(boss3_object)
        boss3_spawned = True

    if random.randint(0, 60) == 0 :
        extra_score = ExtraScore(random.randint(50, WIDTH - 50),
            random.randint(-HEIGHT, -50 - extra_score_img.get_rect().height), extra_score_img, )

        extra_score_group.add(extra_score)

    if score > 3000 and random.randint(0, 100) == 0 :
        meteor_img = random.choice(meteor_imgs)
        meteor_object = Meteors(random.randint(0, 50), random.randint(0, 50), meteor_img, )
        meteor_group.add(meteor_object)

    if random.randint(0, 90) == 0 :
        meteor2_img = random.choice(meteor2_imgs)
        meteor2_object = Meteors2(random.randint(100, WIDTH - 50),
            random.randint(-HEIGHT, -50 - meteor2_img.get_rect().height), meteor2_img, )
        meteor2_group.add(meteor2_object)

    if score > 1000 and random.randint(0, 500) == 0 :
        black_hole_img = random.choice(black_hole_imgs)
        black_hole_object = BlackHole(random.randint(100, WIDTH - 50),
            random.randint(-HEIGHT, -50 - black_hole_img.get_rect().height), black_hole_img, )
    ...
    for meteor_object in meteor_group :
        ...
        for bullet_collision in bullet_collisions :
            ...
            if random.randint(0, 10) == 0 :
                double_refill = DoubleRefill(meteor_object.rect.centerx, meteor_object.rect.centery,
                    double_refill_img, )
        ...
        if score >= 15000 :
            meteor_object.speed = 8
        if score >= 20000 :
            meteor_object.speed = 10  # print(f"Meteor Score speed: {meteor_object.speed:.2f}")
    ...
    for meteor2_object in meteor2_group :
        ...
        for bullet_collision in bullet_collisions :
            ...
            if random.randint(0, 20) == 0 :
                double_refill = DoubleRefill(meteor2_object.rect.centerx,
                    meteor2_object.rect.centery, double_refill_img, )
                double_refill_group.add(double_refill)
    ...
    for enemy_object in enemy1_group :
        ...
        for bullet_collision in bullet_collisions :
            ...
            if random.randint(0, 8) == 0 :
                bullet_refill = BulletRefill(enemy_object.rect.centerx, enemy_object.rect.centery,
                    bullet_refill_img, )
                bullet_refill_group.add(bullet_refill)

            if random.randint(0, 8) == 0 :
                health_refill = HealthRefill(random.randint(50, WIDTH - 30),
                    random.randint(-HEIGHT, -30), health_refill_img, )
    ...
    for enemy2_object in enemy2_group :
        ...
        for bullet_collision in bullet_collisions :
            ...
            if random.randint(0, 20) == 0 :
                double_refill = DoubleRefill(enemy2_object.rect.centerx, enemy2_object.rect.centery,
                    double_refill_img, )
                double_refill_group.add(double_refill)
    ...
    for boss1_object in boss1_group :
        ...
        for bullet_collision in bullet_collisions :
            ...
            if boss1_health <= 0 :
                ...
                if random.randint(0, 20) == 0 :
                    double_refill = DoubleRefill(boss1_object.rect.centerx,
                        boss1_object.rect.centery, double_refill_img, )
                    double_refill_group.add(double_refill)
    ...
    if boss1_group :
        ...
        boss1_health_bar_rect.left, boss1_health_bar_rect.top, boss1_health,
    ...
    for boss2_object in boss2_group :
        ...
        for bullet_collision in bullet_collisions :
            ...
            if boss2_health <= 0 :
                ...
                if random.randint(0, 20) == 0 :
                    double_refill = DoubleRefill(boss2_object.rect.centerx,
                        boss2_object.rect.centery, double_refill_img, )
                    double_refill_group.add(double_refill)
    ...
    if boss2_group :
        ...
        pygame.draw.rect(screen, (0, 255, 0), (
        boss2_health_bar_rect.left, boss2_health_bar_rect.top, boss2_health,
    ...
    for boss3_object in boss3_group :
        ...
        for bullet_collision in bullet_collisions :
            ...
            if boss3_health <= 0 :
                ...
                if random.randint(0, 20) == 0 :
                    double_refill = DoubleRefill(boss3_object.rect.centerx,
                        boss3_object.rect.centery, double_refill_img, )
                    double_refill_group.add(double_refill)
    ...
    if boss3_group :
        ...
        pygame.draw.rect(screen, (0, 255, 0), (
        boss3_health_bar_rect.left, boss3_health_bar_rect.top, boss3_health,
